...
def general_test(filename, sample_size, classifiers, n_cross_validation=5, random_seed=None, filter_fn=None, verbose=False):
...
if __name__ == "__main__":
    ...
    results = general_test(filename=filename, sample_size=sample_size, classifiers=classifiers, filter_fn=filter_fn, verbose=True)
